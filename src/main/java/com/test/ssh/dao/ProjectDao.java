...
public interface ProjectDao {
    public List<Project> getProjects(String projectId, String projectName, int hostGroup, String isSponsor, String projectScale, String startTime, String endTime, int page, int limit);
